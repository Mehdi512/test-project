...
DROP TABLE IF EXISTS `state_transition_permission`;
...
DROP TABLE IF EXISTS `workflow_state_transition`;
...
CREATE TABLE `product_variant` (
  ...
  `is_bundle` TINYINT(1)  NOT NULL  DEFAULT '0'  COMMENT '0 is false, 1 is true',
...
DROP TABLE IF EXISTS `product_tax_map`;
...
DROP TABLE IF EXISTS `related_product_variant`;
