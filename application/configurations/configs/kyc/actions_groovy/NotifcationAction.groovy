...
public class NotifcationAction implements ActionEngineInterface
{
    ...
    String resolveBulkResellerURL = "http://svc-dealer-management:8033/dms/auth/getBulkResellerInfo";
	...
	public void processRequest(KycTransaction kycTransaction) throws IOException, TemplateException
	{
		...
		String url = extendedProperties.getProperty("url", "http://svc-notification-manager:8277/register");
		...
		resolveBulkResellerURL = extendedProperties.getProperty("bulk_reseller_url", "http://svc-dealer-management:8033/dms/auth/getBulkResellerInfo");
