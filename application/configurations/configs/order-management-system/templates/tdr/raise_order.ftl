...
"oms.seller.employeeId":"${(response.seller.employeeId)!'N/A'}",
"oms.seller.street":
...
"oms.buyer.employeeId":"${(response.buyer.employeeId)!'N/A'}",
"oms.buyer.street":
...
"oms.sender.employeeId":"${(response.sender.employeeId)!'N/A'}",
"oms.sender.street":
...
"employeeId":"${(receiver.employeeId)!'N/A'}",
