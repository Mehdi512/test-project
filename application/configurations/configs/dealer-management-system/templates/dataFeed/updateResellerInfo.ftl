"DMS": [{
    ...
    "resellerInfo": {
        "reseller": {
            ...
            "dynamicData": ${response.resellerInfo.resellerData.dynamicDataValue()},
            ...
            <#if response.resellerInfo.additionalFields??>,
                <#list response.resellerInfo.additionalFields as field>
                             "${(field.name)!'N/A'}":"${(field.value)!'N/A'}"<#sep>,
                </#list>
            </#if>
            ...
            "address": {
                         ...
                         "phone":"${response.resellerInfo.resellerData.address.phone!""}"
                }
            </#if>
        },
