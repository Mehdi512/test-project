...
@CompileStatic
class ERSPartnerDeboadNotifierAction extends AbstractAction {
    private static final Logger log = LoggerFactory.getLogger(ERSPartnerDeboadNotifierAction)
    ...
    protected void extractResponseData(HelperTransaction transaction) throws ActionProcessingException {
        log.debug("Extracted action data map: ${transaction.linkActionInProgress.actionRule.action.groovy}")
    }
    ...
    private String createXmlRequest(Object payload, SystemToken systemToken) throws Exception {
        ...
        createDataElement(doc, commandElement, systemToken, resellerInfoMap,
    ...
    private Element createCommandElement(Document doc, SystemToken systemToken) {
        ...
        actionHelperUtils.addElement(doc, commandElement, "TYPE", "USERDELREQ")
    ...
    private Element createDataElement(Document doc, Element commandElement, SystemToken systemToken,
        ...
        actionHelperUtils.addElement(doc, dataElement, "USERORIGINID", actionHelperUtils.getMapValue(extraParamMap, "originId", true, ""))
        actionHelperUtils.addElement(doc, dataElement, "LOGINID", actionHelperUtils.getMapValue(resellerInfoMap, "resellerId", true, ""))
        actionHelperUtils.addElement(doc, dataElement, "EXTERNALCODE", null)
        actionHelperUtils.addElement(doc, dataElement, "REMARKS", null)
