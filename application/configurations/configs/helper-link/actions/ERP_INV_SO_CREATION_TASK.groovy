...
class ERP_INV_SO_CREATION_TASK extends AbstractAction {
    private static final Logger log = LoggerFactory.getLogger(ERP_INV_SO_CREATION_TASK.class)
    ...
    private static final String TASK = ERP_INV_SO_CREATION_TASK.class.name
    @Override
    ...
    static setDefaultSalesOrderVariables(CreateSalesOrderRequest request){
        ...
        request.transactionTypeCode = "GP Dist Single Sales Order"
